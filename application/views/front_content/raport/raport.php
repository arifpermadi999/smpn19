...
<?php if (isset($post)): ?>
	<div class="raport">
		<a href="#" onclick="window.open('<?= base_url('printraport-kelas7') ?>','name','width=700,height=500')" class="btn btn-primary pull-right"><i class="fa fa-print"></i> Cetak RAPORT</a>
		...
		<table class="table table-bordered">
		    <tr>
		        ...
		        <th colspan="1"><center>NILAI</center></th>
		    </tr>
		    <tr>
		        <!--<th>PENGETAHUAN</th>
		        <th>KETERAMPILAN</th>-->
...
<?php else: ?>
	...
	<div class="raport">
		...
		<?php endif ?>
		<h2>APLIKASI RAPORT PTS KELAS 7</h2>
		<p>Silakan Masukkan Nomor Ujian Anda, Pada Form Yang Disediakan.</p>
		<form method="post" action="<?= base_url('raport-kelas7') ?>">
		    <div class="row">
				<div class="col-sm-8 col-sm-offset-1">
					<div class="form-group">
						<input type="text" name="no_induk" class="form-control" placeholder="No Ujian" required>
					</div>
					</div>
				<!--<div class="col-sm-4">
					<div class="form-group">

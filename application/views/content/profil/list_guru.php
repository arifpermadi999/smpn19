<div class="box box-primary">
	<div class="box-body">
		...
		<a href="<?= base_url('C_home/deleteAllGuru') ?>" onclick="return confirm('Apa anda yakin ingin menghapus semua data ?')" class="btn btn-danger"><i class="fa fa-trash-o"></i> Hapus Semua</a>
		<br /><br />
			...
			<tbody>
				<?php $no=1; foreach ($dataGuru as $row): ?>
					<tr>
						...
						<!-- <td><?= $row->kp_photo ?></td> -->
						<td>
							<!-- <a href="<?= base_url('C_home/edit_guru/'.$row->id_guru) ?>"><i class="fa fa-edit"></i></a> -->
							<a href="<?= base_url('C_home/deleteGuru/'.$row->id_guru) ?>" onclick="return confirm('Are you sure ?')"><i class="fa fa-trash-o"></i></a>
						</td>
					</tr>
				<?php $no++; endforeach ?>
			</tbody>
	...
	<div class="modal-dialog" style="width:60%">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="<?= base_url('C_home/uploadGuru') ?>" method="POST" enctype="multipart/form-data">
					<div class="row">
						<div class="col-sm-4">

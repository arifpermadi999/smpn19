<div class="box box-primary">
	<div class="box-body">
		...
		<a href="<?= base_url('C_home/deleteAllStruktur') ?>" onclick="return confirm('Apa anda yakin ingin menghapus semua data ?')" class="btn btn-danger"><i class="fa fa-trash-o"></i> Hapus Semua</a>
		<br /><br />
		<table class="table table-bordered table-hover" id="tablePertama">
			...
			<tbody>
				<?php $no=1; foreach ($dataStruktur as $row): ?>
					<tr>
						<td><?= $no ?></td>
						<td><?= $row->kp_nama ?></td>
						<td><img src="<?= base_url('assets/images/profil/'.$row->kp_photo) ?>" style=width:50%;height:250px;></td>
						<td>
							<a href="<?= base_url('C_home/deleteStruktur/'.$row->id_struktur) ?>" onclick="return confirm('Are you sure ?')"><i class="fa fa-trash-o"></i></a>
						</td>
					</tr>
				<?php $no++; endforeach ?>
			</tbody>
	...
	<div class="modal-dialog" style="width:60%">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="<?= base_url('C_home/uploadStruktur') ?>" method="POST" enctype="multipart/form-data">
					<div class="row">
						<div class="col-sm-4">

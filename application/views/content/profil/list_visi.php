<div class="box box-primary">
	<div class="box-body">
		...
		<a href="<?= base_url('C_home/deleteAllVisi') ?>" onclick="return confirm('Apa anda yakin ingin menghapus semua data ?')" class="btn btn-danger"><i class="fa fa-trash-o"></i> Hapus Semua</a>
		<br /><br />
		<table class="table table-bordered table-hover" id="tablePertama">
			...
			<tbody>
				<?php $no=1; foreach ($dataVisi as $row): ?>
					<tr>
						<td><?= $no ?></td>
						<td><?= $row->kp_nama ?></td>
						...
						<!-- <td><?= $row->kp_photo ?></td> -->
						<td>
							<!-- <a href="<?= base_url('C_home/edit_visi/'.$row->id_visi) ?>"><i class="fa fa-edit"></i></a> -->
							<a href="<?= base_url('C_home/deleteVisi/'.$row->id_visi) ?>" onclick="return confirm('Are you sure ?')"><i class="fa fa-trash-o"></i></a>
						</td>
					</tr>
				<?php $no++; endforeach ?>
			</tbody>
	...
	<div class="modal-dialog" style="width:60%">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="<?= base_url('C_home/uploadVisi') ?>" method="POST" enctype="multipart/form-data">
					<div class="row">
						<div class="col-sm-4">

<div class="box box-primary">
	<div class="box-body">
		...
		<a href="<?= site_url('C_home/deleteAllraport9') ?>" onclick="return confirm('Apa anda yakin ?')" class="btn btn-danger"><i class="fa fa-trash-o"></i> Hapus Semua</a>
		<br /><br />
		<table class="table table-bordered table-hover" id="tablePertama">
			...
			<tbody>
				<?php $no=1; foreach ($dataRaport9 as $row): ?>
					<tr>
						<td><?= $no ?></td>
						<td><?= $row->no_induk ?></td>
						...
						<td><?= $row->alpa ?></td>-->
						<td>
							<a href="<?= site_url('C_home/edit_raport9/'.$row->id_raport) ?>"><i class="fa fa-edit"></i></a>
							<a href="<?= site_url('graduated/GraduatedCtrl/raport9/'.$row->id_raport) ?>" onclick="return confirm('Are you sure ?')"><i class="fa fa-trash-o"></i></a>
						</td>
					</tr>
				<?php $no++; endforeach ?>
			</tbody>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					...
					<div class="col-sm-6">
						<form action="<?= site_url('C_home/import_raport9') ?>" method="POST" enctype="multipart/form-data">

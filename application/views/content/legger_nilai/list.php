<div class="box box-primary">
	<div class="box-body">
		...
		<a href="<?= base_url('C_home/deleteAllLeggerNilai') ?>" onclick="return confirm('Apa anda yakin ?')" class="btn btn-danger"><i class="fa fa-trash-o"></i> Hapus Semua</a>
		<br /><br />
		<table class="table table-bordered table-hover" id="tablePertama">
			...
			<tbody>
				<?php $no=1; foreach ($dataLeggerNilai as $row): ?>
					<tr>
						<td><?= $no ?></td>
						<td><?= $row->no_induk ?></td>
						...
						<td><?= $row->semester ?></td>
						<td>
							<!-- <a href="<?= base_url('C_home/edit_legger_nilai/'.$row->id_legger_nilai) ?>"><i class="fa fa-edit"></i></a> -->
							<a href="<?= base_url('graduated/GraduatedCtrl/legger_nilai/'.$row->id_legger_nilai) ?>" onclick="return confirm('Are you sure ?')"><i class="fa fa-trash-o"></i></a>
						</td>
					</tr>
				<?php $no++; endforeach ?>
			</tbody>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="<?= base_url('graduated/GraduatedCtrl/LeggerNilai') ?>" method="POST" role="form">
					<div class="row">
						<div class="col-sm-6">
...
<div class="modal fade" id="excel">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h4 class="modal-title"><i class="fa fa-upload"></i> Import Data LeggerNilai</h4>
			</div>
			<div class="modal-body">
				<div class="row">
					<div class="col-sm-6">
					...
					<div class="col-sm-6">
						<form action="<?= base_url('C_home/import_legger_nilai') ?>" method="POST" enctype="multipart/form-data">
